...
import xbmc
#import json
#added some extra modules + ability to log messages
...
class Episodes(object):
    ...
    def get_next_episode_for_show(self, show_id):
        ...
        #added "field" firstaired for sorting
...
#        log_msg('PHIL_LOG1', xbmc.LOGNOTICE)
...
#added extra IF to test that airdate is before TODAY
