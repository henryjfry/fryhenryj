...
def action_cancel():
#	xbmc.log(str('def action_cancel():')+'===>OPENMETA', level=xbmc.LOGNOTICE)
...
#	xbmc.log(str('def action_play(item):')+'===>OPENMETA', level=xbmc.LOGNOTICE)
	plugin.play_video(item)

def action_playmedia(item):
#	xbmc.log(str('def action_playmedia(item):')+'===>OPENMETA', level=xbmc.LOGNOTICE)
	xbmc.executebuiltin('PlayMedia("%s")' % item)

def get_video_link(players, params):
#	xbmc.log(str('def get_video_link(players, params):')+'===>OPENMETA', level=xbmc.LOGNOTICE)
	lister = Lister()
...
#	xbmc.log(str('def on_play_video(players, params, trakt_ids=None):')+'===>OPENMETA', level=xbmc.LOGNOTICE)
	assert players
	action_cancel()
	...
	if not selection:
		return
	link = selection['path']
	xbmc.log(str(link)+'===>OPENMETA', level=xbmc.LOGNOTICE)
